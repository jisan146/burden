<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="counter_stuff_duty.aspx.cs" Inherits="WebApplication1.WebForm200" %>
...
<head>
  <meta charset="UTF-8">
  <title>Insert Counter Stuff's Duty</title>
...
<body >
  <div class="login" style="top:45%">
	<h1>Insert Counter Stuff Duty</h1>
    <form id="form2" runat="server">
    
           
            <asp:TextBox ID="TextBox1" runat="server" autofocus="" placeholder="Location Name" aufoucus="" required="required"   ></asp:TextBox>
