...
{
    public partial class married : System.Web.UI.Page
    {
        void l()
        {
            Class1 d = new Class1();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "begin  P_MARRIED('"+TextBox1.Text+"','"+TextBox2.Text+"','"+TextBox3.Text+"','"+Session["id"].ToString()+ "',:p_region_name); end;";
                OracleParameter p_region_name = new OracleParameter("p_region_name", OracleDbType.Varchar2, 100, "", ParameterDirection.Output);
            ...
            TextBox3.Enabled = false; Button1.Visible = false; Button100.Visible = true;
            TextBox1.Text = null;
            TextBox2.Text = null;
            TextBox3.Text = null;
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (TextBox1.Text == "" && a > 4) { TextBox1.Text = p_region_name.Value.ToString(); Button100.Text = "Search Female ID"; }
                    else if (TextBox2.Text == "" && a > 4) { TextBox2.Text = p_region_name.Value.ToString();TextBox3.Enabled = true;Button1.Visible = true;Button100.Visible = false; Button100.Text = "Search Male ID"; FileUpload1.Visible = false; }
