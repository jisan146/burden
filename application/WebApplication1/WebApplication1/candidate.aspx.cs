    ...
    public partial class candidate : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "begin  p_candidate('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox5.Text + "','" + Session["id"].ToString() + "',:p_country_id); end;";
                ...
                Button100.Visible = true; Button1.Visible = false; TextBox1.Enabled = false; TextBox2.Enabled = false; TextBox3.Enabled = false; TextBox5.Enabled = false;
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (TextBox1.Text == "" && a > 4) { TextBox1.Text = p_region_name.Value.ToString(); Button100.Text = "Add Symbol Image"; }
                 
                    else if (TextBox4.Text == "" ) { TextBox4.Text = base64String; TextBox2.Enabled = true; TextBox3.Enabled = true; Button1.Visible = true; Button100.Visible = false; Button100.Text = "Search ID"; TextBox5.Enabled = true; FileUpload1.Visible = false; }
