...
{
    public partial class WebForm200 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Session["grant"] = "counter_stuff_duty.aspx";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
                ...
                OracleParameter p_region_name = new OracleParameter("p_region_name", OracleDbType.Varchar2, 100, "", ParameterDirection.Output);
                OracleCommand cmd = con.CreateCommand();
                cmd.CommandText = "begin x_counter__Stuff('" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + Session["id"].ToString() + "'); end;";
                cmd.ExecuteNonQuery();
