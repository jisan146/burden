<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ticket.aspx.cs" Inherits="WebApplication1.WebForm85" %>
...
<body >
  <div class="login" style="top:30%; ">
    ...
    <form id="form2" runat="server">
        ...
        <asp:TextBox ID="TextBox3" list="date" runat="server" placeholder="Date (dd-mm-yy)" required="required" ></asp:TextBox>

         <asp:Button ID="Button1" runat="server" class="btn btn-primary btn-block btn-large" OnClick="Button1_Click" Text="Search" />
        <div style="margin-top:5px"> <input type="button" id="btnCancel1" class="btn btn-primary btn-block btn-large" value="My Tickets" onclick="GoTo1();"/>
       ...
       <div style="margin-top:10px;margin-bottom:10px">
           ...
           <asp:Button ID="Button3" runat="server"  Visible="false" class="btn btn-primary btn-block btn-large" OnClick="Button3_Click" Text="" />
       </div>
        ...
        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
              ...
              <ItemTemplate>
               <div style="margin-bottom:5px">   <asp:Button ID="Button2" class="btn btn-primary btn-block btn-large" runat="server" TextMode="MultiLine"  Text='<%# "From: "+Eval("location_name")+" ( "+Eval("start_time")+" ) To: "+Eval("location_name1")+" ( "+Eval("end_time")+" ) Distance: "+Eval("km")+" (km)"+" Cost: "+Eval("tk")+" (tk)" %>' Width="700px" /></div>
...
function GoTo1() {
    <% Session["allow"] = null; Session["allow"] = "tic";%>
    ...
    <datalist id="date">  <option value="Today"></option></datalist>
