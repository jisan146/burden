    ...
    public partial class experience : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "begin  crime('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + Session["id"].ToString() + "'); end;";
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               OracleCommand cmd1 = con.CreateCommand();
                    ...
                    cmd1.CommandText = "begin  p_crime_record('"+ p_region_name.Value.ToString() + "',:bbb); end;";
                    OracleParameter bbb = new OracleParameter("p_region_name", OracleDbType.Varchar2, 100, "", ParameterDirection.Output);
                    cmd1.Parameters.Add(bbb);
                    cmd1.ExecuteNonQuery();

                    TextBox4.Text = "Criminal Age: "+aaa.Value.ToString() +" Crime Record: "+ bbb.Value.ToString();
                   //  TextBox1.Text = p_region_name.Value.ToString();
                    int a = int.Parse(p_region_name.Value.ToString().Length.ToString());
                    if (TextBox1.Text == "" && a > 4) { TextBox1.Text = p_region_name.Value.ToString();TextBox2.Enabled = true;TextBox3.Enabled = true;Button1.Visible = true;Button100.Visible = false; FileUpload1.Visible = false; }
