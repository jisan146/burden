...
namespace WebApplication1
{
    public partial class WebForm14 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                l();
                Session["grant"] = "tex_payment.aspx";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            l();
                ...
                cmd.CommandText = "begin    pay_tex('" + TextBox1.Text + "','" + TextBox4.Text + "','" + Session["id"].ToString() + "'); end;";
             

          
                cmd.ExecuteNonQuery();
               
                TextBox1.Text = null; FileUpload1.Visible = true;
            // TextBox2.Text = null;
            TextBox4.Text = null;
            TextBox2.Text = null;
            TextBox4.Enabled = false; Button1.Visible = false; Button100.Visible = true;
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (TextBox1.Text == "" && a > 4) { TextBox1.Text = p_region_name.Value.ToString(); TextBox4.Enabled = true;Button1.Visible = true;Button100.Visible = false; FileUpload1.Visible = false; }
