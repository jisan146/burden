<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Education.aspx.cs" Inherits="WebApplication1.WebForm7" %>
...
<head>
  <meta charset="UTF-8">
  <title>Register Education Details</title>
...
<body >
  <div class="login" style="top:32%;">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            ...
            <asp:TextBox ID="TextBox2" runat="server" autofocus="" placeholder="Details" required="required" Height="112px" MaxLength="200" CssClass="textbox" TextMode="MultiLine" Enabled="False"></asp:TextBox>
            <asp:TextBox ID="TextBox3" runat="server" placeholder="EIIN Code" required="required" MaxLength="15" Enabled="False"></asp:TextBox>
            <asp:TextBox ID="TextBox4" runat="server" placeholder="Level" required="required" MaxLength="5" Enabled="False"></asp:TextBox>
        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="textbox">
              <asp:ListItem>Graduation Type</asp:ListItem>
            <asp:ListItem>Graduate</asp:ListItem>
            <asp:ListItem>Continue</asp:ListItem>
           
        </asp:DropDownList>
         <asp:TextBox ID="TextBox6" runat="server" placeholder="Applicant Age" required="required" MaxLength="5" Enabled="False"></asp:TextBox>
