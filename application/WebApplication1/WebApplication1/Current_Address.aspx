<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Current_Address.aspx.cs" Inherits="WebApplication1.WebForm4" %>

<!DOCTYPE html>
<html >
<head>
  <meta charset="UTF-8">
  <title>Register current Address</title>
...
<body s>
  <div class="login" style="top:32%">
	<h2>Register Current Address</h2>
    <form id="form2" runat="server">
            ...
            <asp:TextBox ID="TextBox2" runat="server"  autofocus="" placeholder="Address / ঠিকানা" required="required" Height="107px" CssClass="textbox" TextMode="MultiLine" Enabled="False"></asp:TextBox>
           <asp:TextBox ID="TextBox3" runat="server"  autofocus="" placeholder="Applicant Age" required="required"  Enabled="False"></asp:TextBox>   
