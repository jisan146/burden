...
namespace WebApplication1
{
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        { string c = null;
            if (DropDownList1.SelectedItem.Text.ToLower() == "graduate" )
                c = "y";
           else if (DropDownList1.SelectedItem.Text.ToLower() == "continue")
                c = "n";
            if (c != null)
            {
                l();
                ...
                cmd.CommandText = "begin  p_edu('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + Session["id"].ToString() + "','" + Session["pass"].ToString() + "',:p_region_name,'" + c+ "'); end; ";
                OracleParameter p_region_name = new OracleParameter("p_region_name", OracleDbType.Varchar2, 100, "", ParameterDirection.Output);
                ...
                TextBox2.Enabled = false; TextBox3.Enabled = false; TextBox4.Enabled = false; Button1.Visible = false; Button100.Visible = true;
                TextBox1.Text = null;
                TextBox2.Text = null;
                TextBox3.Text = null;
                TextBox4.Text = null;
                ...
                c = null;
                TextBox6.Text = null; FileUpload1.Visible = true;
               
            }
            else { msgbox("Graduate field Require"); }
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    cmd.ExecuteNonQuery();
                    TextBox6.Text = "Applicant Age:" + aaa.Value.ToString();
                    int a = int.Parse(p_region_name.Value.ToString().Length.ToString());

                    TextBox1.Text = p_region_name.Value.ToString();

                    if (TextBox1.Text != "" && a > 4) { TextBox2.Enabled = true;TextBox3.Enabled = true;TextBox4.Enabled = true;Button1.Visible = true;Button100.Visible = false; FileUpload1.Visible = false; }
