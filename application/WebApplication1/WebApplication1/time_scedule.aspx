<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="time_scedule.aspx.cs" Inherits="WebApplication1.WebForm80" %>
...
<head>
  <meta charset="UTF-8">
  <title>Insert Time Schedule</title>
...
<body >
  <div class="login" style="top:35%">
	<h2>Insert Time Schedule</h2>
    <form id="form2" runat="server">
          ...
          <asp:TextBox ID="TextBox4" runat="server" placeholder="Stop Time (hh:mm am)" required="required"  ></asp:TextBox>
