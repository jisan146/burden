...
{
    public partial class disable_people : System.Web.UI.Page
    {
        void l()
        {
            Class1 d = new Class1();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                l();
                Session["grant"] = "disable_people.aspx";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "begin  P_DIS('" + TextBox1.Text + "','" + TextBox3.Text + "','" + Session["id"].ToString() + "'); end;";
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (TextBox1.Text != "" && a > 4) { TextBox3.Enabled = true; Button1.Visible = true; Button100.Visible = false; FileUpload1.Visible = false; }
