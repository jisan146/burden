    ...
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (TextBox1.Text != TextBox3.Text)
            {
                ...
                cmd.CommandText = "begin p_work('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + Session["id"].ToString() + "','"+Session["pass"].ToString()+ "',:p_region_name); end; ";
                OracleParameter p_region_name = new OracleParameter("p_region_name", OracleDbType.Varchar2, 100, "", ParameterDirection.Output);
            ...
            TextBox2.Enabled = false; TextBox3.Enabled = false; TextBox4.Enabled = false; Button1.Visible = false; Button100.Visible = true; TextBox1.Text = null;
            TextBox2.Text = null;
            TextBox3.Text = null; TextBox5.Text = null;
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    cmd.ExecuteNonQuery();
                    TextBox5.Text = "Applicant Age:" + aaa.Value.ToString();
                    int a = int.Parse(p_region_name.Value.ToString().Length.ToString());

                    if (TextBox1.Text == "" && a > 4) { TextBox1.Text = p_region_name.Value.ToString();TextBox2.Enabled = true;TextBox3.Enabled = true;TextBox4.Enabled = true;Button1.Visible = true;Button100.Visible = false; FileUpload1.Visible = false; }
