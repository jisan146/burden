<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Work.aspx.cs" Inherits="WebApplication1.WebForm8" %>

<!DOCTYPE html>
<html >
<head>
  <meta charset="UTF-8">
  <title>Register work Information</title>
...
<body >
  <div class="login" style="top:32%" >
	<h2>Register work Information</h2>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            ...
            <asp:TextBox ID="TextBox2" runat="server" autofocus="" placeholder="Details" required="required" Height="112px" CssClass="textbox" TextMode="MultiLine" Enabled="False"></asp:TextBox>
              <asp:TextBox ID="TextBox3" runat="server" placeholder="salary/Income" required="required" TextMode="Number" Enabled="False" ></asp:TextBox>
              <asp:TextBox ID="TextBox4" runat="server" placeholder="Join/Start Date (dd-MON-yy)" required="required" Enabled="False" ></asp:TextBox>
