...
namespace WebApplication1
{
    public partial class WebForm16 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                l();
                Session["grant"] = "passport_verify.aspx";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "begin  P_PASSPORT('" + TextBox1.Text + "','" + Session["id"].ToString() + "'); end;";
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (TextBox1.Text == "" && a > 4) { TextBox1.Text = p_region_name.Value.ToString();   Button1.Visible = true; Button100.Visible = false; FileUpload1.Visible = false; }
