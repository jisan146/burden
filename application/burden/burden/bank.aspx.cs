...
namespace WebApplication1
{
    public partial class bank : System.Web.UI.Page
    {
        ...
        {
            l();
            if (TextBox1.Text != TextBox4.Text && TextBox1.Text != TextBox5.Text && TextBox5.Text != TextBox4.Text )
            {
                if (con.State != ConnectionState.Open)
                    con.Open();
                ...
                cmd.CommandText = "begin ins_bank('"+TextBox1.Text+"','"+TextBox2.Text+"','"+TextBox3.Text+"','"+TextBox4.Text+"','"+TextBox5.Text+"','"+Session["id"].ToString()+"'); end;";
                cmd.ExecuteNonQuery();
            ...
            else { msgbox("id , references, nominy can not be same"); }
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                  ...
                  else  if (TextBox4.Text =="" && a > 4) { TextBox4.Text = p_region_name.Value.ToString(); Button100.Text = "Search Nominy ID"; }
                   else if (TextBox5.Text =="" && a > 4) { TextBox5.Text = p_region_name.Value.ToString(); TextBox2.Enabled = true; TextBox3.Enabled = true;Button1.Visible = true;Button100.Visible = false; Button100.Text = "Search Account Holder ID"; FileUpload1.Visible = false; }
