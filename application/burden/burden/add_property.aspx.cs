...
namespace WebApplication1
{
    public partial class add_property : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                l();
                Session["grant"] = "add_property.aspx";
                con.Open();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "begin  p_property('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "',:p_country_id,'" + Session["id"].ToString() +"'); end;";
               ...
               cmd.Parameters.Add(p_country_id);
                ...
                TextBox2.Enabled = false; TextBox3.Enabled = false; Button1.Visible = false; Button100.Visible = true;
        ...
        protected void Button100_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (TextBox1.Text == "" && a > 4) { TextBox1.Text = p_region_name.Value.ToString();Button100.Text = "Add Document Image";  }
                    else { TextBox4.Text = base64String; TextBox2.Enabled = true; TextBox3.Enabled = true; Button1.Visible = true; Button100.Visible = false; Button100.Text = "Search ID"; FileUpload1.Visible = false; FileUpload1.Visible = false; }
